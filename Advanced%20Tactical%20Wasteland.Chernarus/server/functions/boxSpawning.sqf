...
_nerfBoxes = ["basicUS","basicUS2","basicRU","basicRU2","basicGER","basicPMC","basicSpecial","basicSpecial2","basicSpecial3","medbox1","medbox2","medbox3","electronics1","ruckbox"];

for "_i" from 0 to 1020 step 25 do
{
