...
switch(_selectedBox) do {
	...
	case "medbox1": { // medical
    	_currBox = createVehicle ["ACE_BandageBoxWest", _selectedBoxPos,[], 30, "NONE"];
        ...
        // Add ammunition
        _currBox addMagazineCargoGlobal ["ACE_Splint",50];
        _currBox addMagazineCargoGlobal ["ACE_Bandage",50];
        _currBox addMagazineCargoGlobal ["ACE_Epinephrine",50];
        _currBox addMagazineCargoGlobal ["ACE_IV",35];
        _currBox addMagazineCargoGlobal ["ACE_LargeBandage",50];
        _currBox addMagazineCargoGlobal ["ACE_Medkit",25];
		_currBox addMagazineCargoGlobal ["ACE_Morphine",50];
		_currBox addMagazineCargoGlobal ["ACE_Plasma",10];
    };
	case "medbox2": { // medical
    	_currBox = createVehicle ["ACE_BandageBoxWest", _selectedBoxPos,[], 30, "NONE"];
	...
	//case "electronics1": { // radios and else
    //	_currBox = createVehicle ["ACE_BandageBoxWest", _selectedBoxPos,[], 30, "NONE"];
	...
	//	_currBox addWeaponCargoGlobal ["ItemGPS",5];
	//	_currBox addWeaponCargoGlobal ["ACE_DAGR",2];
	//	_currBox addWeaponCargoGlobal ["ACE_Kestrel4500",3];
	//	_currBox addWeaponCargoGlobal ["ACE_HuntIR_monitor",2];
	//	_currBox addWeaponCargoGlobal ["ACE_ANPRC77",1];
    //   _currBox addWeaponCargoGlobal ["ACE_P159_RD90",5];
    //    _currBox addWeaponCargoGlobal ["ACE_P159_RD54",5];
    //    _currBox addWeaponCargoGlobal ["ACRE_PRC343",10];
	//	_currBox addWeaponCargoGlobal ["ACRE_PRC152",10];
	//	_currBox addWeaponCargoGlobal ["ACRE_PRC148_UHF",10];
	//	_currBox addMagazineCargoGlobal ["ACE_HuntIR_M203",10];
	//	_currBox addMagazineCargoGlobal ["IRStrobe",15];
    //};
	case "ruckbox": { // rucks and misc
    	_currBox = createVehicle ["GERBasicWeapons_EP1", _selectedBoxPos,[], 30, "NONE"];
		...
		_currBox addWeaponCargoGlobal ["ACE_Backpack_RPG",5];
		_currBox addWeaponCargoGlobal ["ACE_CharliePack",2];
		_currBox addWeaponCargoGlobal ["ACE_CharliePack_ACU_Medic",2];
		_currBox addWeaponCargoGlobal ["ACE_DSHKMProxy",2];
		_currBox addWeaponCargoGlobal ["ACE_DSHKMTripodProxy",2];
		_currBox addWeaponCargoGlobal ["ACE_M220Proxy",2];
		_currBox addWeaponCargoGlobal ["ACE_M220TripodProxy",2];
		_currBox addWeaponCargoGlobal ["ACE_Rucksack_EAST_Medic",5];
		_currBox addWeaponCargoGlobal ["ACE_ALICE_Backpack",5];
		_currBox addWeaponCargoGlobal ["ACE_CharliePack_Multicam",2];
    };
