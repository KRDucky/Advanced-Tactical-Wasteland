...
_vehicleClass = ["MtvrRefuel_DES_EP1","MtvrReammo_DES_EP1","MtvrRepair_DES_EP1","ACE_UralReammo_RU","ACE_UralRefuel_RU","ACE_UralRepair_RU"] call BIS_fnc_selectRandom;
