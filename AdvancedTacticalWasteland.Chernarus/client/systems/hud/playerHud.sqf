...
while {true} do
{
    ...
    _vitals ctrlSetStructuredText parseText format ["%2 <img size='0.8' image='client\icons\food.paa'/><br/>%3 <img size='0.8' image='client\icons\water.paa'/><br/>%4 <img size='0.8' image='\CA\misc\data\icons\picture_money_CA.paa'/>", _health, hungerLevel, thirstLevel, (player getVariable "cmoney")];
